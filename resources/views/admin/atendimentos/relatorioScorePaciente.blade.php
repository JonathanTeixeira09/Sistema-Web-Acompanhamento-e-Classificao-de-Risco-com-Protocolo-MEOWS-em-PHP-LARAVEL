                ...
                <div id="avaliacaoView" style="{{ $evolucao->avaliacao ? 'display:block' : 'display:none' }}">
                    @if($evolucao->avaliacao)
                        ...
                        <div class="form-group">
                            ...
                            <div class="p-3 bg-light rounded">
{{--                                {!! nl2br(e($evolucao->user->profissional->nome .  " - ". $evolucao->user->profissional->cargo->nome . " <br> " . $evolucao->avaliacao->created_at->format('d/m/Y H:i:s'))) !!}--}}
                                {!! implode('<br>', [
                                    e($evolucao->user->profissional->nome . ' - ' . $evolucao->user->profissional->cargo->nome),
                                    e($evolucao->avaliacao->created_at->format('d/m/Y H:i:s'))
                                ]) !!}
                            </div>
                        </div>
